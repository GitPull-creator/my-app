...
export default class Task extends Component {
  ...
  render() {
    const { description, onDelete, onToggleCompleted, completed, created, onEditClick, editing } = this.props;
    ...
    return (
      <li className={className}>
        <div className="view">
          <input className="toggle" type="checkbox" defaultChecked={checked} onClick={onToggleCompleted} />
          <label>
        ...
        {editing ? (
          <form onSubmit={this.onSubmit}>
            <input type="text" className="edit" onChange={this.onValueChange} />
          </form>
        ) : null}
      </li>
    );
